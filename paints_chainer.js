  ...
  function paint(data) {
    ...
    $.ajax({
      ...
      success: function () {
        ...
        $('#output_links').html( 
							"<h4>Download</h4>"
							+ "<a href='/images/out/" + image_id + "tmp_out.png' target='_blank'>Resized to original size.</a><br>"
							+ "<a href='/images/out/" + image_id + "med_mult.png' target='_blank'>Resize and multiply line.</a><br>"
							+ "<a href='/images/out/" + image_id + "median_color.png' target='_blank'>Resized color output only. ( line part is white )</a><br>"
                			+ "<a href='/images/out/" + image_id + "median_color_soft.png' target='_blank'>Resized color output only with gaussian filter. ( line part is white )</a><br>"
							);
      },
      error: function () {
